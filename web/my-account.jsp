<%-- 
    Document   : my-account
    Created on : May 1, 2024, 7:20:11 PM
    Author     : Chathushka
--%>
				...
				<div class="row">
						...
						<div class="padding60">
							...
							<div class="prament-area main-input">
								<ul class="panel-group" id="accordion">
									<li class="panel">
										<div class="account-title" data-bs-toggle="collapse" data-bs-parent="#accordion" data-bs-target="#collapse1">
											<label>
												...
												<div class="custom-input">
													<form action="#">
														...
														<div class="custom-mess">
															<textarea rows="2" placeholder="Additional information" name="message"></textarea>
														</div>
									...
									<li class="panel panelimg">
										<div class="account-title"  data-bs-toggle="collapse" data-bs-parent="#accordion" data-bs-target="#collapse2">
											<label>
									...
									<li class="panel panelimg">
										<div class="account-title" data-bs-toggle="collapse" data-bs-parent="#accordion" data-bs-target="#collapse3">
											<label>
												<input type="radio" value="forever" name="rememberme"/>
												my address
											</label>
									...
									<li class="panel">
										<div class="account-title" data-bs-toggle="collapse" data-bs-parent="#accordion" data-bs-target="#collapse4">
											<label>
												<input type="radio" value="forever" name="rememberme"/>
											...
											<div class="single-log-info">
												...
												<div class="custom-input">
													<form action="#">
														...
														<input type="password" placeholder="Current Password" name="password" value="" />
														<input type="password" placeholder="New Password" name="password" value="" />
														<input type="password" placeholder="Confirmation" name="password" value="" />
														<div class="row">
															<div class="col-12">
					...
					<div class="col-md-6">
						<div class="my-right-side">
							...
							<a href="cart.jsp">Order history and details</a>
						</div>
					</div>
				</div>
			</div>
